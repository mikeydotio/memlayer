...
- [ ] Verify milestones via `gh api`
- [ ] Verify issue assignments via `gh issue list`
- [ ] Confirm roadmap.md matches GitHub state

## Commits

| Commit | Contents | Pushed? |
|--------|----------|---------|
| (pending) | roadmap.md rewrite + this progress file | No |
